 ...
 * @author Hamish Lin
 */
public class JDialogCheckZigbeeHistory extends javax.swing.JDialog {
     ...
     */
    public JDialogCheckZigbeeHistory(ClientDemo parent, boolean modal, String fID, String iID) {
        super(parent, modal);
        initComponents();
        this.jParent = parent;
        this.familyID = fID;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int isConnect = connection.selectOption(2, familyID, indiID, jTextField1.getText() + "-" + jTextField2.getText() + "-" +jTextField3.getText());
        if(isConnect == 0)
